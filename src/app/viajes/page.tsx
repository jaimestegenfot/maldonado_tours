...
const HERO_IMG = 'https://images.unsplash.com/photo-1506744038136-46273834b3fb';
...
export default function ViajesPage() {
  ...
  const fetchZones = async () => {
    setLoading(true);
    const res = await fetch('/api/zones?category=Naturaleza');
    ...
    <div className="space-y-16">
      ...
      <section className="max-w-6xl mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-500">No se encontraron destinos de naturaleza.</div>
        ) : (
