...
const HERO_IMG = 'https://images.unsplash.com/photo-1504674900247-0877df9cc836';
...
export default function RestaurantesPage() {
  ...
  const fetchZones = async () => {
    setLoading(true);
    const res = await fetch('/api/zones?category=Restaurante');
    ...
    <div className="space-y-16">
      ...
      <section className="max-w-6xl mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-500">No se encontraron restaurantes.</div>
        ) : (
